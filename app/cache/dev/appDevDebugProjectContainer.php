...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'landing.manager.mailer' => 'getLanding_Manager_MailerService',
            'landing.manager.message' => 'getLanding_Manager_MessageService',
            'landing.manager.preference' => 'getLanding_Manager_PreferenceService',
            'landing.manager.type_vehicle' => 'getLanding_Manager_TypeVehicleService',
            'landing.manager.vehicle' => 'getLanding_Manager_VehicleService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'message.listener' => 'getMessage_ListenerService',
    ...
    /**
     * Gets the public 'data_collector.ladybug_data_collector' shared service.
     *
     * @return \RaulFraile\Bundle\LadybugBundle\DataCollector\LadybugDataCollector
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postPersist'), $this->get('message.listener'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'landing', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/LandingBundle/Entity'))), 'LandingBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('LandingBundle' => 'LandingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_592fbc1bdddb33add7c9711f973c9cfcdf25c3e0215ac1cc711fa5cdfe75cb71');
    ...
    /**
     * Gets the public 'ladybug.dumper' shared service.
     *
    ...
    /**
     * Gets the public 'ladybug.event_listener.ladybug_config_listener' shared service.
     *
     * @return \RaulFraile\Bundle\LadybugBundle\EventListener\LadybugConfigListener
     */
    ...
    /**
     * Gets the public 'landing.manager.mailer' shared service.
     *
     * @return \LandingBundle\Manager\Mailer
     */
    protected function getLanding_Manager_MailerService()
    {
        return $this->services['landing.manager.mailer'] = new \LandingBundle\Manager\Mailer($this->get('swiftmailer.mailer.default'), 'landing.page.opel.comercial@gmail.com', $this->get('templating'), $this);
    }

    /**
     * Gets the public 'landing.manager.message' shared service.
     *
     * @return \LandingBundle\Manager\MessageManager
     */
    protected function getLanding_Manager_MessageService()
    {
        return $this->services['landing.manager.message'] = new \LandingBundle\Manager\MessageManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'landing.manager.preference' shared service.
     *
     * @return \LandingBundle\Manager\PreferenceManager
     */
    protected function getLanding_Manager_PreferenceService()
    {
        return $this->services['landing.manager.preference'] = new \LandingBundle\Manager\PreferenceManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'landing.manager.type_vehicle' shared service.
     *
     * @return \LandingBundle\Manager\TypeVehicleManager
     */
    protected function getLanding_Manager_TypeVehicleService()
    {
        return $this->services['landing.manager.type_vehicle'] = new \LandingBundle\Manager\TypeVehicleManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'landing.manager.vehicle' shared service.
     *
     * @return \LandingBundle\Manager\VehicleManager
     */
    protected function getLanding_Manager_VehicleService()
    {
        return $this->services['landing.manager.vehicle'] = new \LandingBundle\Manager\VehicleManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the public 'message.listener' shared service.
     *
     * @return \LandingBundle\Listener\MessageListener
     */
    protected function getMessage_ListenerService()
    {
        return $this->services['message.listener'] = new \LandingBundle\Listener\MessageListener($this);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('landing.page.opel.comercial@gmail.com');
        $a->setPassword('Opel1234.');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/LandingBundle/Resources/views'), 'Landing');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('414b4f7fe2860f25228b0e387c9b5971d52fb656');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59c91f194a9e45.71739935')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LandingBundle' => 'LandingBundle\\LandingBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'RaulFraileLadybugBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/raulfraile/ladybug-bundle/RaulFraile/Bundle/LadybugBundle'),
                    'namespace' => 'RaulFraile\\Bundle\\LadybugBundle',
                ),
                'LandingBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/LandingBundle'),
            ...
            'mailer_user' => 'landing.page.opel.comercial@gmail.com',
            'mailer_password' => 'Opel1234.',
            'secret' => '414b4f7fe2860f25228b0e387c9b5971d52fb656',
            ...
            'kernel.secret' => '414b4f7fe2860f25228b0e387c9b5971d52fb656',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'landing.page.opel.comercial@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Opel1234.',
